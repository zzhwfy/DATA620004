...
def resnet101_fpn_backbone():
    # FrozenBatchNorm2d的功能与BatchNorm2d类似，但参数无法更新
    # norm_layer=misc.FrozenBatchNorm2d
    resnet_backbone = ResNet(Bottleneck, [3, 4, 23, 3],
                             include_top=False)

    resnet_backbone.load_state_dict(torch.load(r"D:\new_-deeplearning\project\faster_rcnn\backbone\resnet101.pth"),strict=False)
