...
def main(parser_data):
    device = torch.device("cuda:{}".format(str(parser_data.gpu_id)) if torch.cuda.is_available() else "cpu")
    ...
    val_data_set = VOCDataSet(VOC_root, data_transform["val"], "val.txt")
    ...
    model.load_state_dict(weights_dict['models'])
    # print(models)
...
if __name__ == "__main__":
    ...
    # 数据集的根目录(VOC2012根目录)
    parser.add_argument('--datapath', default= '../dataset', help='dataset root')
