...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        writer.add_scalar('Loss/train', mloss.cpu().sum().item(), epoch)
        ...
        if RANK in [-1, 0]:
            ...
            if not noval or final_epoch:  # Calculate mAP
                ...
                writer.add_scalar('Test/Rrecision', results[0], epoch)
                writer.add_scalar('Test/Recall', results[1], epoch)
                writer.add_scalar('Test/mAP@0.5', results[2], epoch)
                writer.add_scalar('Test/mAP@0.5-0.95', results[3], epoch)
                writer.add_scalar('Loss/test', sum(results[4:]), epoch)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--tf_log', type=str, default='./tf_logs/finetune')
...
if __name__ == "__main__":
    opt = parse_opt()
    writer = SummaryWriter(opt.tf_log)
    main(opt)
